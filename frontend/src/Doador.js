        ...
        <div className="row text-center">
          ...
          <div className="col-lg-4">
            <div className="card m-4">                            
              ...
              <div className="card-body">
                <p>Se você não pode contribuir com o Kit, não tem problema nenhum. Nós aceitamos a doação de qualquer valor também. A cada R$ 80 arrecadados, montamos um Kit para doação.</p>
              </div>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="card m-4">                            
              ...
              <div className="card-body">
                <p>Caso tenha material escolar disponível, novo e em boa condição de uso, pode doar diretamente em uma de nossas ONG's parceiras. Eles farão a separação e montagem de um Kit seguindo nossas diretrizes.</p>
              </div>
            </div>
          </div>
        </div>
